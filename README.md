...
В каждой записи `PRODUCTS_JSON` можно указать массив `markers`; товар будет выбран, если в описании заказа найден любой из них. Это удобно для русских и английских вариантов одного лота.
